...
import '../services/weather_services_pro.dart';
  ...
  void initState() {
    ...
    locationProvider.determinePosition().then((_) {
      if (locationProvider.currentLocationName != null) {
        var city = locationProvider.currentLocationName!.country;
        if (city != null) {
          Provider.of<WeatherServicesProvider>(context, listen: false).fetchWeatherDataByCity(city.toString());
        }
      }
    });
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(onPressed: (){
                        Provider.of<WeatherServicesProvider>(context, listen: false).fetchWeatherDataByCity(_cityController.text.toString());
